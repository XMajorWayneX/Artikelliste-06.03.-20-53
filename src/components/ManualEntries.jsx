...
function ManualEntries() {
  ...
  const anlagentypOptions = ["USV", "BSV", "GR", "Bat", "PS", "PP", "PS2", "CSS", "Sibelon", "Merlin", "Sonstiges"].sort();
  const angefragtBeiOptions = ["Freimann", "Bonecke", "Steuernagel", "Theis", "Sonstige", "Jörger"].sort();
  const angefragtVonOptions = ["Fetzer", "Baus", "Ehnert"].sort();
  const statusOptions = ["angefragt", "Absage", "angebot erhalten"].sort();
